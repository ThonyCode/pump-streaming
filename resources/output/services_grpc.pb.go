...
type StreamingServiceClient interface {
	StreamData(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (StreamingService_StreamDataClient, error)
}
...
func (c *streamingServiceClient) StreamData(ctx context.Context, in *StreamRequest, opts ...grpc.CallOption) (StreamingService_StreamDataClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamingService_ServiceDesc.Streams[0], "/pump.StreamingService/StreamData", opts...)
	if err != nil {
		return nil, err
	}
...
func (x *streamingServiceStreamDataClient) Recv() (*StreamResponse, error) {
...
type StreamingServiceServer interface {
	StreamData(*StreamRequest, StreamingService_StreamDataServer) error
}
...
func (UnimplementedStreamingServiceServer) StreamData(*StreamRequest, StreamingService_StreamDataServer) error {
...
func (x *streamingServiceStreamDataServer) Send(m *StreamResponse) error {
...
var StreamingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pump.StreamingService",
	...
	Metadata: "resources/services.proto",
}
